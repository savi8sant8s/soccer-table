                ...
                <div className="container-fluid">
                    <div className="row justify-content-center">
                        <div className="jumbotron text-center text-light p-2">
                            <h1 className="display-6">Termos de uso</h1>
                        </div>
                        <div style={{textAlign: "justify"}} className="col-sm-6 text-light p-3 mt-3">
                            ...
                            privacidade
                            em relação a
                        qualquer informação sua que possamos coletar no site <a style={{color: "#F1B24A"}} href="/">Tabela de
                            Futebol</a>, e outros
                        sites que possuímos e operamos.</p>
                            ...
                            serviço. Fazemo-lo por
                            meios justos e legais, com o seu conhecimento e consentimento. Também informamos por que estamos
                            coletando e como
                        será usado. </p>
                            <p>Apenas retemos as informações coletadas pelo tempo necessário para fornecer o serviço solicitado.
                            Quando armazenamos
                            dados, protegemos dentro de meios comercialmente aceitáveis ​​para evitar perdas e roubos, bem
                            como
                            acesso,
                        ...
                        entre em contacto connosco.</p>
                            ...
                            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Tabela de
                            Futebol
                            oferece no site e
                        com caráter enunciativo, mas não limitativo:</p>
                            ...
                            pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
                                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Tabela de
                                Futebol,
                                de seus
